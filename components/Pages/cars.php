...
<body class="bg-gray-50 text-gray-800">
      ...
      <div class="flex flex-col items-center justify-center text-center">
        ...
        <?php 
          if (isset($_SESSION['name'])) {
            ...
            echo "<button onclick=\"openLoginModal()\" class='bg-gray-800 text-white px-4 py-2 rounded shadow-sm hover:bg-gray-900 transition'>Book Now</button>";
          }
        ?>
      </div>
    </div>
  ...
  <script>
    ...
    function openLoginModal() {
      // Apna login modal kholne ka function
